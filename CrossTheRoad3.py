...
class Game:
    ...
    def run_game_loop(self, level_speed):
        ...
        enemy_1 = EnemyCharacter('asset/musuh1.png', 20, 600, 50, 50)
        enemy_1.SPEED *= level_speed
        enemy_2 = EnemyCharacter('asset/musuh2.png', self.width - 40, 400, 50, 50)
        enemy_2.SPEED *= level_speed
        enemy_3 = EnemyCharacter('asset/musuh3.png', 20, 50, 50, 50)
        ...
        while not is_game_over:
            ...
            elif player_character.detection_collision(enemy_3):
                is_game_over = True
                did_win = False
                text = font.render('You Lose! :(', True, BALCK_COLOR)
                self.game_screen.blit(text, (300, 350))
